    ...
    <div className="min-h-screen bg-background text-on-background font-body-md flex flex-col relative overflow-hidden select-none pt-20">
      ...
      <nav className="fixed top-0 w-full z-40 bg-surface/80 backdrop-blur-xl border-b border-white/10 h-20">
        <div className="px-gutter h-full max-w-container-max mx-auto flex items-center justify-between relative">
          ...
          <div onClick={() => router.push("/")} className="flex items-center gap-3 text-2xl font-display-xl font-bold tracking-tight text-white cursor-pointer select-none">
          ...
          <div className="absolute left-1/2 -translate-x-1/2 hidden md:flex items-center gap-3 lg:gap-5 xl:gap-8 whitespace-nowrap">
            ...
            <a onClick={() => router.push("/debugger/record")} className="text-on-surface-variant hover:text-on-surface transition-colors text-[15px] lg:text-[16px] xl:text-[17px] font-extrabold cursor-pointer whitespace-nowrap shrink-0">
              职业记忆看板
            </a>
            <a onClick={() => router.push("/debugger/training")} className="text-on-surface-variant hover:text-on-surface transition-colors text-[15px] lg:text-[16px] xl:text-[17px] font-extrabold cursor-pointer whitespace-nowrap shrink-0">
              面试训练场
            </a>
            <a onClick={() => router.push("/debugger/report")} className="text-primary transition-colors text-[15px] lg:text-[16px] xl:text-[17px] font-extrabold cursor-pointer relative whitespace-nowrap shrink-0 after:content-[''] after:absolute after:bottom-[-26px] after:left-0 after:right-0 after:h-[2px] after:bg-primary">
              职业驾驶舱
            </a>
          ...
          <div className="glass-panel p-6 rounded-3xl border-white/10 flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 text-left relative overflow-hidden w-full">
            ...
            <div className="flex items-stretch w-full lg:w-auto border-t lg:border-t-0 pt-4 lg:pt-0 border-white/5 shrink-0 justify-between lg:justify-start">
              ...
              <div className="flex gap-6 px-5 py-4 rounded-2xl bg-white/[0.02] border border-white/5 shrink-0 w-full sm:w-auto justify-between sm:justify-start">
                ...
                <div className="w-px bg-white/10 self-stretch my-1 shrink-0" />
                <div className="text-left whitespace-nowrap min-w-0">
                  <span className="text-[10px] text-on-surface-variant/40 font-label-mono uppercase tracking-widest font-extrabold block">当前职级</span>
                  <span className="text-sm font-black text-tertiary block mt-0.5 whitespace-nowrap">{profile.level}</span>
                </div>
              </div>
              ...
              <div className="glass-panel p-5.5 rounded-3xl border-white/10 text-left h-full flex flex-col justify-start gap-4 hover:border-secondary/20 transition-all duration-300">
                ...
                <div className="grid grid-cols-2 gap-3.5 py-1 mt-[-2px]">
                  {[
                    ...
                    { label: "开始模拟面试", sub: "AI 面试官实战演练", icon: "support_agent", color: "text-amber-500 bg-amber-500/10 border-amber-500/20", path: "/debugger" }
                  ].map((act, i) => (
                    <button
                      key={i}
                    ...
                    >
                      ...
                      <div className="min-w-0">
                        ...
                        <span className="text-[10px] text-on-surface-variant/30 font-bold block truncate mt-1.5">{act.sub}</span>
                      </div>
                    </button>
                  ))}
                </div>
