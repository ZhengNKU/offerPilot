...
async def analyze_resume_text(
    ...
    system_prompt = (
        ...
        "    - work_experience / projects section 的 before / after 优先用简历中真实 bullets 的 originalText / optimizedText；\n"
        "      其他 section 原简历可能没对应内容，按目标岗位画像自由生成合理范例；\n"
        "    - **岗位类型差异化分析**：根据候选人简历中的岗位性质（技术岗 vs 非技术岗），对统一 section 做不同侧重点的分析：\n"
        "      - idx=3（professional_capability，专业能力）：技术岗侧重\"框架/中间件/底层原理\"等技术栈能力；非技术岗侧重\"硬技能/工具/证书/方法论\"等专业能力\n"
        "      - idx=4（works_portfolio，作品/案例）：技术岗侧重\"开源贡献/GitHub/技术文章/社区参与\"等；非技术岗侧重\"项目交付物/客户案例/公开演讲/行业文章/课程/专利/比赛\"等可展示成果\n"
        "      其他 5 个通用 section 无差异，按实际简历内容自由优化即可。\n"
        "\n"
        ...
        "      \"professional_capability\": { \"status\": \"优秀\", \"score\": 90, \"desc\": \"...\", \"advice\": [\"...\"], \"before\": \"...\", \"after\": \"...\" },\n"
        "      \"works_portfolio\":         { \"status\": \"优秀\", \"score\": 90, \"desc\": \"...\", \"advice\": [\"...\"], \"before\": \"...\", \"after\": \"...\" },\n"
